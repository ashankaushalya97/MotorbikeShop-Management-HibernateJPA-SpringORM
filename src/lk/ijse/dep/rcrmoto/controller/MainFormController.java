...
public class MainFormController {
    ...
    public void initialize(){
        ...
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Home.fxml"));
    ...
    public void btnCustomer_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Customer.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
        } catch (IOException e) {
    ...
    public void btnInventory_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Inventory.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
    ...
    public void btnOrder_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Order.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
    ...
    public void btnDelivery_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Delivery.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
    ...
    public void btnSearch_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Search.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
    ...
    public void btnReports_OnAction(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dep/rcrmoto/view/Reports.fxml"));
            ArpStage.getChildren().clear();
            ArpStage.getChildren().add(root);
            fade(root);
