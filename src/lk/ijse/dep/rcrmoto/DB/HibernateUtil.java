...
public class HibernateUtil {
    ...
    private static SessionFactory buildSessionFactory() {
        ...
        try (InputStream fis = HibernateUtil.class.getResourceAsStream("/lk/ijse/dep/rcrmoto/application.properties")){
            properties.load(fis);
        }catch (Exception e){
        ...
        StandardServiceRegistry standardRegistry = new StandardServiceRegistryBuilder()
                .loadProperties("lk/ijse/dep/rcrmoto/application.properties")
